...
video_path = "./videos/lotr_frodo_sam.mp4"
...
lmm_image = face_recognition.load_image_file("./cast/Elijah Wood.png")
lmm_face_encoding = face_recognition.face_encodings(lmm_image)[0]

al_image = face_recognition.load_image_file("./cast/Sean Astin.png")
